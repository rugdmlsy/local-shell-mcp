...
def remote_routes() -> list[Any]:
    ...
    return [
        ...
        Route(f"{remote.REMOTE_API_PREFIX}/events-ack", remote.events_ack_endpoint, methods=["POST"]),
        Route(f"{remote.REMOTE_API_PREFIX}/worker-event", remote.worker_event_endpoint, methods=["POST"]),
        Route(f"{remote.REMOTE_API_PREFIX}/mobile-dashboard", remote.mobile_dashboard_endpoint, methods=["POST"]),
