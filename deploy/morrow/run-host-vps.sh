...
# Adjacent services must selectively inherit the control credential from the
# private service.env at process startup. Do not maintain a second secret copy.
rm -f "${config_root}/control-api-key"
